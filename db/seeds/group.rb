  ...
  [
    {
      ...
      content: '1.1	2030年までに、現在1日1.25ドル未満で生活する人々と定義されている極度の貧困をあらゆる場所で終わらせる。
      ...
      youtube_url: 'https://youtu.be/LUO8IPslPBA'
    },
    {
      name: '２、飢餓をゼロに',
      image: File.open('app/assets/images/2.png'),
      content: '2.1	2030年までに、飢餓を撲滅し、全ての人々、特に貧困層及び幼児を含む脆弱な立場にある人々が一年中安全かつ栄養のある食料を十分得られるようにする。

      2.2	５歳未満の子供の発育阻害や消耗性疾患について国際的に合意されたターゲットを2025年までに達成するなど、2030年までにあらゆる形態の栄養不良を解消し、若年女子、妊婦・授乳婦及び高齢者の栄養ニーズへの対処を行う。
      ...
      youtube_url: 'https://youtu.be/-tpF6z1QUQ0'
    },
    {
      name: '３、すべての人に健康と福祉を',
      image: File.open('app/assets/images/3.png'),
      content: '3.1	2030年までに、世界の妊産婦の死亡率を出生10万人当たり70人未満に削減する。

      3.2	全ての国が新生児死亡率を少なくとも出生1,000件中12件以下まで減らし、５歳以下死亡率を少なくとも出生1,000件中25件以下まで減らすことを目指し、 2030年までに、新生児及び５歳未満児の予防可能な死亡を根絶する。
      
      3.3	2030年までに、エイズ、結核、マラリア及び顧みられない熱帯病といった伝染病を根絶するとともに肝炎、水系感染症及びその他の感染症に対処する。
      
      3.4	2030年までに、非感染性疾患による若年死亡率を、予防や治療を通じて３分の１減少させ、精神保健及び福祉を促進する。
      ...
      youtube_url: 'https://youtu.be/drce2K2oyhc'
    },
    {
      name: '４、質の高い教育をみんなに',
      image: File.open('app/assets/images/4.png'),
      content: '4.1	2030年までに、全ての子供が男女の区別なく、適切かつ効果的な学習成果をもたらす、無償かつ公正で質の高い初等教育及び中等教育を修了できるようにする。
      ...
      youtube_url: 'https://youtu.be/YONd1cPQSi4'
    },
    {
      name: '５、ジェンダー平等を実現しよう',
      image: File.open('app/assets/images/5.png'),
      content: '5.1	あらゆる場所における全ての女性及び女児に対するあらゆる形態の差別を撤廃する。
      ...
      youtube_url: 'https://youtu.be/vJLeOV1_3sw'
    },
    {
      name: '６、安全な水とトイレを世界中に',
      image: File.open('app/assets/images/6.png'),
      content: '6.1	2030年までに、全ての人々の、安全で安価な飲料水の普遍的かつ衡平なアクセスを達成する。
      ...
      youtube_url: 'https://youtu.be/_rB2-qFXfhA'
    },
    {
      name: '７、エネルギーをみんなに そしてクリーンに',
      image: File.open('app/assets/images/7.png'),
      content: '7.1	2030年までに、安価かつ信頼できる現代的エネルギーサービスへの普遍的アクセスを確保する。
      ...
      youtube_url: 'https://youtu.be/TykbjS2fNqI'
    },
    {
      name: '８、働きがいも経済成長も',
      image: File.open('app/assets/images/8.png'),
      content: '8.1	各国の状況に応じて、一人当たり経済成長率を持続させる。特に後発開発途上国は少なくとも年率７%の成長率を保つ。
      ...
      youtube_url: 'https://youtu.be/I4DPMHFicBs'
    },
    {
      name: '９、産業と技術革新の基盤をつくろう',
      image: File.open('app/assets/images/9.png'),
      content: '9.1	全ての人々に安価で公平なアクセスに重点を置いた経済発展と人間の福祉を支援するために、地域・越境インフラを含む質の高い、信頼でき、持続可能かつ強靱（レジリエント）なインフラを開発する。
      ...
      youtube_url: 'https://youtu.be/bzoCic3lxD0'
    },
    {
      name: '１０、人や国の不平等をなくそう',
      image: File.open('app/assets/images/10.png'),
      content: '10.1	2030年までに、各国の所得下位40%の所得成長率について、国内平均を上回る数値を漸進的に達成し、持続させる。
      ...
      10.c	2030年までに、移住労働者による送金コストを３%未満に引き下げ、コストが5%を越える送金経路を撤廃する。',
      youtube_url: 'https://youtu.be/pVKf6pa9LiQ'
    },
    {
      name: '１１、住み続けられるまちづくりを',
      image: File.open('app/assets/images/11.png'),
      content: '11.1	2030年までに、全ての人々の、適切、安全かつ安価な住宅及び基本的サービスへのアクセスを確保し、スラムを改善する。
      ...
      youtube_url: 'https://youtu.be/fhmi0B8cvyM'
    },
    {
      name: '１２、つくる責任 つかう責任',
      image: File.open('app/assets/images/12.png'),
      content: '12.1	開発途上国の開発状況や能力を勘案しつつ、持続可能な消費と生産に関する10年計画枠組み（10YFP）を実施し、先進国主導の下、全ての国々が対策を講じる。
      ...
      youtube_url: 'https://youtu.be/QlmsgT1-7YY'
    },
    {
      name: '１３、気候変動に具体的な対策を',
      image: File.open('app/assets/images/13.png'),
      content: '13.1	全ての国々において、気候関連災害や自然災害に対する強靱性（レジリエンス）及び適応の能力を強化する。
      ...
      youtube_url: 'https://youtu.be/mwS0kAR5OI8'
    },
    {
      name: '１４、海の豊かさを守ろう',
      image: File.open('app/assets/images/14.png'),
      content: '14.1	2025年までに、海洋ごみや富栄養化を含む、特に陸上活動による汚染など、あらゆる種類の海洋汚染を防止し、大幅に削減する。
      ...
      youtube_url: 'https://youtu.be/pB_6qf3OZMM'
    },
    {
      name: '１５、陸の豊かさも守ろう',
      image: File.open('app/assets/images/15.png'),
      content: '15.1	2020年までに、国際協定の下での義務に則って、森林、湿地、山地及び乾燥地をはじめとする陸域生態系と内陸淡水生態系及びそれらのサービスの保全、回復及び持続可能な利用を確保する。
      ...
      youtube_url: 'https://youtu.be/6C7tgiYYwX4'
    },
    {
      name: '１６、平和と公正をすべての人に',
      image: File.open('app/assets/images/16.png'),
      content: '16.1	あらゆる場所において、全ての形態の暴力及び暴力に関連する死亡率を大幅に減少させる。
      ...
      youtube_url: 'https://youtu.be/0emmQsgoUiA'
    },
    {
      name: '１７、パートナーシップで目標を達成しよう',
      image: File.open('app/assets/images/17.png'),
      content: '資金
      ...
      youtube_url: 'https://youtu.be/FwllDhkzW5w'
    },
  ]
)